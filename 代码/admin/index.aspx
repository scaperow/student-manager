             ...
             FadeTransitions="true" FramesPerSecond="40" TransitionDuration="250"
              ...
              <Panes>
                <cc1:AccordionPane ID="AccordionPane1" runat="server" ContentCssClass="" HeaderCssClass="">
                    <Header>
           <a href ="student.aspx" target ="right" >学生信息</a> 
                    </Header>
                    <Content>
                        <center><font color ="red" size="2px" ><%=Session ["username"] %></font>管理员，欢迎您访问！</center><br />

                    </Content>
                </cc1:AccordionPane>
                <cc1:AccordionPane ID="AccordionPane2" runat="server" ContentCssClass="" HeaderCssClass="">
                <Header>
                        <a href="course.aspx"  target ="right">课程管理</a>                    </Header>
                    <Content>
                ...
                <Header>
                        <a href="score.aspx" target="right">成绩管理</a>
                    </Header>
                    <Content>
                        <center>欢迎您访问<asp:HyperLink ID="HyperLink3" runat="server"  Target ="right" NavigateUrl="score.aspx" Text="成绩管理" />！</center><br />
                ...
                <Header>
                    ...
                    <Content>
                        <center>账号：<font color ="red"><%=Session ["userid"] %></font><br />密码：<font color ="red"><%=Session ["userpwd"] %></font><br />欢迎您访问<asp:HyperLink ID="HyperLink1" runat="server" target ="right" NavigateUrl="help.aspx" Text="帮助" />！</center><br />
